add_wave {{/testbench/my_example/my_timing/pclk}}
...
add_wave {{/testbench/my_example/my_timing/hBlankCounter}}
...
add_wave {{/testbench/my_example/my_timing/vBlankCounter}}