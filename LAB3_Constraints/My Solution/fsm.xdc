...
set_property PACKAGE_PIN R3 [get_ports {state[0]}]
set_property PACKAGE_PIN T1 [get_ports even]
set_property PACKAGE_PIN U1 [get_ports odd]
...
set_property PACKAGE_PIN U2 [get_ports restart]
set_property PACKAGE_PIN U3 [get_ports rst]
set_property PACKAGE_PIN T3 [get_ports terminal]
